  ...
  return (
    <>
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <div className="mt-1 text-sm text-slate-500">
              Manage all customers, states, tags, and follow-up context here.
            </div>
          </div>
      ...
      {loadingContacts ? (
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 text-sm text-slate-500 shadow-sm">No contacts yet. Create your first one from the Capture page.</div>
      ) : (
